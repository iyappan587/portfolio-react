...
function Footer() {
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/iyappan587",
      icon: (
        <svg
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/iyappan-k-378036330",
      icon: (
        <svg
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/sabari__2005/tagged",
      icon: (
        <svg
          className="w-6 h-6 fill-white hover:fill-pink-400 transition"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"
        >
    ...
    },
    {
      ...
      icon: (
        <svg
          className="w-6 h-6 fill-white hover:fill-blue-600 transition"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"
        >
  ...
  return (
    <footer id="contact" className="bg-gray-800 text-white py-6">
      <div className="mx-auto text-center w-19">
